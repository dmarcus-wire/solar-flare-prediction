...
│
├── images             <- Images supporting the project
│
...
│
├── pyproject.toml     <- Project configuration file with package metadata for solar_flare_demo
...
│
└── solar_flare_demo                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes solar_flare_demo a Python module
    │
